...
import { faA, faArrowRightFromBracket, faEllipsisVertical, faGear, faPlus } from '@fortawesome/free-solid-svg-icons';
import {
  faBookmark,
  faCircleQuestion,
  faCreditCard,
    ...
    <header className={cx('wrapper')}>
      <div className={cx('inner')}>
        ...
        <div className={cx('action')}>
          <Button variant="secondary" outline rounded="2" size="small" leftIcon={<FontAwesomeIcon icon={faPlus} />}>
            Tải lên
          </Button>
          {currentUser ? (
            <>
